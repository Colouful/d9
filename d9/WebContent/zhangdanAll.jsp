...
List<User> list=new ArrayList<User>();
		...
		list=UserDao.queryZhangdanlists();
		
		moneyXinjin=UserDao.queryAcountEverydayAndXianjin();
		moneyZhuanzhang=UserDao.queryAcountEverydayAndZhuanZhang();
		moneyGuazhang=UserDao.queryAcountEverydayAndGuaZhang();
		sum=UserDao.queryAcountEverydayAndAll();
               ...
               <!--    <li> <a class="waves-effect waves-dark" href="queryVipUser.jsp" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">查询会员</span></a></li>
                  ...
                  <li> <a class="waves-effect waves-dark" href="vipczinfo.jsp" aria-expanded="false"><i class="mdi mdi-book-open-variant"></i><span class="hide-menu">会员充值记录</span></a></li>
                    ...
                    <div class="text-center m-t-30">
                        <a href="#" class="btn waves-effect waves-light btn-info hidden-md-down"> 查询所有账单</a>
                    </div>
                </nav>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">查询所有账单</h3>
                    </div>
				            ...
				            <div class="card-body">
				                ...
				                <form action="" method="">
				                	<table border="0" cellspacing="" cellpadding="">
				                		<tr>
											<td>所有账单查询：</td>
											<td><input type="text" style="width: 300px;" id="" placeholder="请输入查询日期/格式为:yyyy-MM-dd" value="" /></td>
										</tr>
				                		
										<tr>
											<td colspan="2"><input type="submit" id="" name="" value="查询" /></td>
