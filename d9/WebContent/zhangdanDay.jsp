...
<%@page import="shuaiwei.DB.DBUtil"%>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">查询当日账单</h3>
                    </div>
				    ...
				    <div class="col-lg-12">
				        <div class="card">
				            <div class="card-body">
				                ...
				                <form action="zhangdanDay.jsp" method="post">
				                	<table border="0" cellspacing="" cellpadding="">
				                		<tr>
											<td>当日账单查询：</td>
											<td><input type="text" name="queryString" onchange="checkBtn()"  style="width: 300px;" id="txt" placeholder="请输入查询日期/格式为:yyyy-MM-dd" value="<%=str %>" /></td>
										</tr>
				                		
										<tr>
											<td colspan="2"><input type="submit" id="btnOK" name="" value="查询" disabled="disabled"/></td>
